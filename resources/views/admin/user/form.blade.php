@extends('layout.admin-master',['page_title'=>'Tạo mới người dùng','active'=>''])
@section('css')
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-default">
                    <div class="panel-body"><h4 style="color: #333333">Add User</h4></div>
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <h5>Tên</h5>
                            <input type="text" placeholder="Nhập tên" size="100" name="name">
                        </div>
                        <div class="form-group">
                            <label>Email :</label>&nbsp;&nbsp;&nbsp;&nbsp;
