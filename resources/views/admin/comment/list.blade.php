...
@section('content')
    ...
    <div class="row form-group" style="margin-top: 30px">
        <div class="col-md-12 col-xs-12">
            <a href="/admin/comment/create" class="btn btn-primary">Tạo mới</a>
        </div>
    </div>
    <!-- col-md-12 -->
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    @foreach($cmt as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="/admin/comment/{{$item->id}}/edit" class="btn btn-outline-primary">Sửa</a>
                                ...
                                @else
                                    <div class="alert alert-primary" role="alert">
                                        Hiện tại chưa có tài khoản nào, vui lòng <a title="Thêm mới user" class="btn-link" href="/admin/comment/create">thêm sản phẩm</a> mới.
                                    </div>
                                @endif
                            </div>
                        </div>
