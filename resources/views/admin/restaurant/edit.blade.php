@extends('layout.admin-master',['page_title'=>'Edit restaurant','active'=>''])
@section('css')
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="category">
                                @foreach($category as $c)
                                    <option value="{{$restaurant->categoryID}}">{{$c->name}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <img src="/images/restaurant/{{$restaurant->avartar}}" width="150px" height="150px">
                            <div class="kv-avatar">
                                <div class="file-loading">
                                    <input id="product_image" type="file" name="avartar"
                                           value="{{$restaurant->avartar}}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" name="shortDescription" placeholder="Nhập mô tả ngắn" cols="100"
                                      role="3">{{$restaurant->shortDescription}}</textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            @foreach($album_restaurant as $a)
                                <div class="col-md-3">
                                    <img src="/images/restaurant/{{$a->image}}" width="100%">
                                </div>
                            @endforeach
                        </div>
                        {{--<div class="form-group">--}}
