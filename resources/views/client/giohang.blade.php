@extends('layout.master',['page_title'=>'giỏ hàng sản phẩm'])
@section('css')
...
@section('content')
    ...
    <div class="container">
        ...
        <table id="cart" class="table table-hover table-condensed">
            ...
            <tr>
                    
                <td><a href="http://hocwebgiare.com/" class="btn btn-warning"><i class="fa fa-angle-left"></i> Tiếp tục
                        mua hàng</a>
                        
                </td>
                    
    ...
    </div><h2 class="text-center">Hướng dẫn thiết giao diện trang giỏ hàng bằng Bootstrap</h2>
    <div class="container">
         
        <table id="cart" class="table table-hover table-condensed">
              
