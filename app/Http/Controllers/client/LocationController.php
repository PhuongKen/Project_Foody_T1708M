...
//        dd($map);
        ...
        return view('client.nearBy', compact('categories', 'countRestaurant', 'list_restaurant', 'lat', 'lng','categoryID','map'));
    }
...
//        dd($list_restaurant[0]);
        ...
        return view('client.nearByCategory', compact('categories', 'countRestaurant',
            'list_restaurant', 'lat', 'lng','category','categoryID','map'));
    }
}